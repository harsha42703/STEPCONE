<header class="header0">
            ...
            <a  href="#" class="header0__logo" style="font-family: Samarkan Normal V2; text-decoration: none;  font-size: 28px; background-color: transparent; font-weight: 500; color: white;" >Stepcone</a>
