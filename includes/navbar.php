<header class="header0">
            ...
            <a  href="#" class="header0__logo" style="font-family: 'yatra one',sans-serif; text-decoration: none;  font-size: 28px; background-color: transparent; font-weight: 500; color: white;" >Stepcone</a>
                ...
                <div class="nva__content bd-grid">
                    <div class="main_left_nva">
                        <a style=" text-decoration: none;"  href="" class="nva__perfil">
                            ...
                            <div>
                                <span class="nva__name" style="font-family: 'yatra one',sans-serif; font-size: 28px;">Stepcone</span>
                            </div>
                        </a>    
                    </div>
